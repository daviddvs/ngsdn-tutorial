...
class TutorialTopo(Topo):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # gRPC port 50004
        spine2 = self.addSwitch('spine2', cls=StratumBmv2Switch, cpuport=CPU_PORT, grpcport=50004)
        ...
        #spine2int = Intf("eno1", node=spine2)
        self.addIntf(spine2,"eth2")
        self.addIntf(leaf2, "eth1")
